...
<head>
	...
	<link rel="stylesheet" href="${path}/assets/assets_howon/css/login.css">
...
<div id="cu10_a" class="cu10">
  ...
  <div class="cu10_a_wrap">
    <div class="mb_title sg_app">
      <h2>사운드그램<span>의</span> 칩디스크</h2>
      <h3>음악을 소장하고 즐기는 새로운 방법</h3>
    </div>
    <div class="mb_title chst_app">
      <h2><span>내 여행의 </span>새로운 방법, 칩스터</h2>
    ...
    <div class="mb_content">
      ...
      <button class="btn_login own" onclick="javascript:lj_popup('_l');">
        <img src="${path}/assets/image/login/cu01_ic_login_black.png" alt="">보유 계정으로 로그인
      </button>
      <button class="btn_bt_line" onclick="javascript:lj_popup('_j');"><img src="${path}/assets/image/login/cu10_ic_write.png" alt="">
